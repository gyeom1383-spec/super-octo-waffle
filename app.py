...
소녀가 속삭이듯이, 이리 들어와 앉으라고 했다. 괜찮다고 했다. 소녀가 다시 들어와 앉으라고 했다. 할 수 없이 뒷걸음질을 쳤다. <u>ⓑ그 바람에 소녀가 안고 있는 꽃묶음이 우그러들었다.</u>""",
        "question": "지문1의 ⓐ와 지문2의 ⓑ의 의미를 비교하여 작성해 봅시다.",
        "hint": "지문1의 ⓐ는 소년의 어떤 마음이 담겨 있는지, 지문2의 ⓑ인 '우그러진 꽃'은 앞으로 두 사람에게 일어날 사건을 어떻게 암시하는지 생각해 보세요.",
        "placeholder": "ⓐ 싱싱한 꽃을 건네는 행동은 [               ] 의미를 담고 있다.\nⓑ 꽃묶음이 우그러지는 모습은 앞으로 두 사람에게 [               ] 것을 암시한다.",
        "answer_frame": "ⓐ 싱싱한 꽃을 건네는 행동은 [               ] 의미를 담고 있다.<br>ⓑ 꽃묶음이 우그러지는 모습은 앞으로 두 사람에게 [               ] 것을 암시한다.",
        "key_answer": "ⓐ는 소녀를 향한 소년의 순수한 사랑(호감, 정성)을 의미하고, ⓑ는 앞으로 두 사람의 관계에 닥칠 위기나 이별(슬픈 결말)을 암시함.",
    },
    {
        "id": 5,
        "tag": "인물의 심리",
