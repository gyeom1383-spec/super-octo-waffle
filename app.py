...
(학생이 종이 학습지에 바로 옮겨 적을 수 있도록, 긴 문장 대신 짧고 명확한 핵심어 위주(개조식)로 아주 간단하게 작성하세요.)
- 잘한 점: (예: '좋아하는 마음'이라고 표현한 점)
- 고칠 점: (예: 소녀가 돌을 던진 진짜 이유 찾아서 덧붙이기)
- 생각 힌트: (예: '이 바보'라고 말할 때의 소녀의 진짜 속마음은?)"""
