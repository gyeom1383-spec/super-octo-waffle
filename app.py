...
소년은 저도 모르게 벌떡 일어났다.""",
    ...
    },
    {
        "id": 2,
        "tag": "소재의 상징",
        "excerpt": """다음 날부터 좀 더 늦게 개울가로 나왔다. 소녀의 그림자가 뵈지 않았다. 다행이었다.
그러나 이상한 일이었다. 소녀의 그림자가 뵈지 않는 날이 계속될수록 소년의 가슴 한구석에는 어딘가 허전함이 자리 잡는 것이었다. **주머니 속 조약돌을 주무르는 버릇**이 생겼다.""",
        "question": "다음 장면에서 밑줄 친 소재가 의미하는 바를 작성하시오.",
    ...
    },
    {
        "id": 3,
        "tag": "인물의 심리",
        "excerpt": """논 사잇길로 들어섰다. 벼 가을걷이하는 곁을 지났다.
...
ⓑ **돌아다보니 소녀는 지금 자기가 지나쳐 온 허수아비를 흔들고 있다. 좀 전 허수아비보다 더 우쭐거린다.**""",
        "question": "ⓐ와 ⓑ를 중심으로 소녀의 심리가 어떻게 변했는지 작성하시오.",
...
"마타리꽃."
소녀는 마타리꽃을 양산 받듯이 해 보인다. 약간 상기된 얼굴에 살폿한 보조개를 떠올리며.
다시 소년은 **꽃 한 옴큼**을 꺾어 왔다. 싱싱한 꽃가지만 골라 소녀에게 건넨다.
그러나 소녀는,
"하나두 버리지 말어."

[지문2]
수숫단 속은 비는 안 새었다. 그저 어둡고 좁은 게 안됐다. 앞에 나앉은 소년은 그냥 비를 맞아야만 했다. 그런 소년의 어깨에서 김이 올랐다.
소녀가 속삭이듯이, 이리 들어와 앉으라고 했다. 괜찮다고 했다. 소녀가 다시 들어와 앉으라고 했다. 할 수 없이 뒷걸음질을 쳤다. 그 바람에 소녀가 안고 있는 **꽃묶음**이 우그러들었다.""",
        "question": "지문1의 '꽃 한 옴큼'과 지문2의 '꽃묶음'의 의미를 비교하여 작성하시오.",
        "hint": "지문1은 교과서 32페이지를, 지문2는 교과서 36페이지를 확인하세요.",
        "placeholder": "'꽃 한 옴큼'은 [의미]를 나타내고, '꽃묶음'은 [의미]를 나타낸다.",
        "answer_frame": "'꽃 한 옴큼'은 [소년이 소녀에게 전하는 마음/행동의 의미]를 나타내고, '꽃묶음'은 [소녀가 소년과의 추억을 소중히 여기는 마음의 의미]를 나타낸다.",
        "key_answer": "'꽃 한 옴큼'은 소년이 소녀에게 마음을 전하려는 순수한 호감과 배려를 상징함. '꽃묶음'은 소나기 속에서도 소녀가 소년과 함께한 시간을 소중히 여기며 놓지 않으려는 마음을 상징함. 꽃묶음이 우그러져도 상관없다고 생각한 것은 소년(사람)이 꽃(추억의 물건)보다 더 소중했기 때문임.",
    },
    {
        "id": 5,
        "tag": "인물의 심리",
        "excerpt": """이날 밤, 소년은 몰래 덕쇠 할아버지네 호두밭으로 갔다.
낮에 봐 두었던 나무로 올라갔다. 그리고 봐 두었던 가지를 향해 작대기를 내리쳤다. 호두 송이 떨어지는 소리가 별나게 크게 들렸다. 가슴이 선뜩했다. 그러나 다음 순간, 굵은 호두야 많이 떨어져라, 많이 떨어져라, 저도 모를 힘에 이끌려 마구 작대기를 내리치는 것이었다.
**돌아오는 길에는 열이틀 달이 지우는 그늘만 골라 짚었다. 그늘의 고마움을 처음 느꼈다.**""",
        "question": "소년이 그늘만 짚어 돌아온 이유를 작성하시오.",
        "hint": "교과서 40페이지를 확인해보세요.",
        "placeholder": "소년이 그늘만 짚어 돌아온 것은 [이유]이기 때문이다.",
        "answer_frame": "소년이 그늘만 짚어 돌아온 것은 [행동의 이유 — 들키지 않으려는 심리]이기 때문이다.",
    ...
    },
    {
        "id": 6,
        "tag": "인물의 심리",
        "excerpt": """"글쎄 말이지. 이번 앤 꽤 여러 날 앓는 걸 약두 변변히 못 써 봤다더군. 지금 같애서는 윤 초시네두 대가 끊긴 셈이지……. 그런데 참 이번 계집애는 어린것이 여간 잔망스럽지가 않어. 글쎄 죽기 전에 이런 말을 했다지 않어? 자기가 죽거든 **자기 입던 옷을 꼭 그대루 입혀서 묻어 달라**구……." """,
        "question": "소녀가 입던 옷을 그대로 입혀서 묻어 달라고 한 이유를 작성해봅시다.",
        "hint": "교과서 42페이지를 확인하세요.",
        "placeholder": "소녀가 입던 옷을 그대로 입혀 달라고 한 것은 [이유]이기 때문이다.",
        "answer_frame": "소녀가 입던 옷을 그대로 입혀 달라고 한 것은 [소년과의 추억/감정과 연결된 이유]이기 때문이다.",
...
- 이 문항의 핵심: 작품 속 인물의 행동과 소재에 담긴 심리와 의미를 맥락에서 추론하는 것
