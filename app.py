...
# ✅ Gemini 2.5 Flash-Lite 스트리밍 함수
def get_feedback(q, answer):
    api_key = st.secrets["GEMINI_API_KEY"]
    url = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-lite-preview-06-17:streamGenerateContent?alt=sse&key={api_key}"
...
- 힌트가 되는 지문:"""
    ...
    try:
        ...
        with requests.post(url, headers=headers, json=payload, stream=True, timeout=25) as res:
                ...
                if line:
                    ...
                    if line_str.startswith("data: "):
                        ...
                        try:
                            ...
                            full_text += chunk
                            placeholder.markdown(full_text)  # ✅ 실시간 화면 표시
                        except:
                            continue
